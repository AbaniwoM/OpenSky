...
const arrivalInASpecificAirport =
  "flights/arrival?airport=EDDF&begin=1517227200&end=1517230800";
...
const Data = () => {
  ...
  return (
    <div
      className="Data"
      style={{ paddingTop: 120, display: "flex", color: "white", marginLeft: 25 }}
    >
      {/* {flights.map((flight, index) => ( */}
      {/* <div key={index}> */}
      {/* Airport */}
      <h2 style={{ marginRight: 8 }}>DFL</h2>

      {/* Current Time */}
      <h2 style={{ marginRight: 8 }}>| {time} CAT</h2>

      {/* Number of Flights Arriving */}
      <h2 style={{ marginRight: 8 }}>| {arrivalCount}</h2>
